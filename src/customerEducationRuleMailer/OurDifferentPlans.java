...
//	 String actualEmail="";
	...
	@Test(enabled=true,priority=15, groups={"CustomerEducationRuleMail", "All"})
	   public void ourDifferentPlansTC090501() throws InterruptedException
	   {
		log.info("Inside Our different plans script");
		
		 log.info("Fetching data from databse MySQL");
		  result=info.getDataForCustomerInfo("OurDifferentPlans"); 
...
//						String actualEmail = email.getTo() ;
	...
	@Test(enabled=true, priority=16, groups={"CustomerEducationRuleMail", "All"})
	...
	@Test(enabled=true, priority=17, groups={"CustomerEducationRuleMail", "All"})
