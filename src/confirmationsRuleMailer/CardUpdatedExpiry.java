...
public class CardUpdatedExpiry extends SuperTestScript 
{
	...
	public void cardUpdatedExpiry() 
	{
		...
		if (memTypeCode.equalsIgnoreCase("201002")) // <---------- card update
													// for
													// FREE_GIFTCARD_NOCARDINFO
		{
			Assert.assertEquals(memberStatus, "FREE_GIFTCARD_MEMBER");
			log.info("FREE_GIFTCARD_NOCARDINFO changed to FREE_GIFTCARD_MEMBER");
		}

		else if (memTypeCode.equalsIgnoreCase("305006")) // <---------- card
															// update for
		...
		else if (memTypeCode.equalsIgnoreCase("205006")) // <---------- card
															// update for
															// FREE_CARD_EXPRIYDUE
		{
		...
		else if (memTypeCode.equalsIgnoreCase("203002")) // <---------- card
															// update for
															// FREE_TRIAL_MEMBER
		{
		...
		else if (memTypeCode.equalsIgnoreCase("304001")) // <---------- card
															// update for
															// MEMBER_PAYING
		{
			Assert.assertEquals(memberStatus, "MEMBER_PAYING");
		...
		{
			log.info("card updated for member Type Code: ' " + memTypeCode
					+ " ' and after the card update the MemberType is: '" + memberStatus + "'");
		}
	...
	public void negativeFlows() {
		{
			...
			if (memTypeCode.equalsIgnoreCase("201002")) // <---------- card
														// update for
														// FREE_GIFTCARD_NOCARDINFO
			{
				Assert.assertEquals(memberStatus, "FREE_GIFTCARD_MEMBER");
