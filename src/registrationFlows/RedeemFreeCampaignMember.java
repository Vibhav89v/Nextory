...
public class RedeemFreeCampaignMember extends SuperTestScript 
{
	...
	public void freeCampaignMemberNewUserBas() throws EncryptedDocumentException, InvalidFormatException, IOException {
		...
		String act1 = driver
				.findElement(By
						.xpath("//div[@class='col-xs-12 col-sm-6 col-lg-5 usp__headers']//h3[1]//span[@class='samewidth']"))
				.getText();
		...
		String act2 = driver
				.findElement(By
						.xpath("//div[@class='col-xs-12 col-sm-6 col-lg-5 usp__headers']//h3[2]//span[@class='samewidth']"))
				.getText();
		String actTrim2 = act2.replaceAll("\\s+", "");
		Assert.assertEquals(actTrim2, "119kr");
		log.info("Making payment where Your Offer / Ditt erbjudande: Gratis i " + act1
				+ " and Pris/mån efter gratisperioden: " + act2);
		...
		cust.clickContinue();
		log.info("Campaign code Successfully redeemed for SILVER");
		...
		String exp1 = "SILVER:119kr/månad";
	...
	public void freeCampaignMemberNewUserStandard()
		...
		String act2 = driver
				...
				.getText();
		String actTrim2 = act2.replaceAll("\\s+", "");
		Assert.assertEquals(actTrim2, "169kr");
		log.info("Making payment where Your Offer / Ditt erbjudande: Gratis i " + act1
				+ " and Pris/mån efter gratisperioden: " + act2);
		...
		cust.enterMobileNumber(cellNum);
		cust.clickContinue();
		log.info("Campaign code Successfully redeemed for GULD");
	...
	public void freeCampaignMemberNewUserPremium()
			throws EncryptedDocumentException, InvalidFormatException, IOException {
		campCode = Excel.getCellValue(INPUT_PATH, "CampaignCodes", 1, 0);
		newId = RandomEmail.email();
		confirm = newId;
		...
		cust.enterMobileNumber(cellNum);
		cust.clickContinue();
		log.info("Campaign code Successfully redeemed for FAMILJ");
		...
		String actualSub = driver
				.findElement(By.xpath("//div[@class='my-account-wrapper clearfix']//li[@class='right']")).getText();
		String actualSubtrim = actualSub.replaceAll("\\s+", "");
		String exp1 = "FAMILJ:199kr/månad";
		Assert.assertEquals(actualSubtrim, exp1);
		log.info("Order is " + actualSub);
	...
	public void freeCampaignMemberExistingUser()
			throws EncryptedDocumentException, InvalidFormatException, IOException 
	{
		...
		// Excel.setExcelData(INPUT_PATH, "ExistingEmail", 2, 4,
	...
	public void redeemCampaignInvalidInputs() throws EncryptedDocumentException, InvalidFormatException, IOException {
		log.info("REDEEMING CAMPAIGN AS A NEW USER FOR SILVER SUBSCRIPTION : NEGATIVE FLOWS");
		...
		Assert.assertEquals(actConfEmailErrTrim, expConfEmailErr,
				"Error Message at Upprepa e-postadress field Doesnot matches.");
		...
		Assert.assertEquals(actWrongCodErrTrim, expWrongCodErr,
				" Error Message on entering Wrong Campaign Code does not matches");
		...
		// SCENARIO 4 : ENTERING THE PASSWORD WITH LESS THAN 4 CHARACTERS OR
		...
		camp.clearPassword();
		camp.enterPassword("123456789QWERTYUIOPLKJHGFDSAZX"); // ENTERING WITH
																// MORE THAN 25
																// CHARACTERS
		camp.clickToContinue();
