...
public class RedeemGiftCards extends SuperTestScript 
{
	...
	// -----------------------------------Redeeming GiftCard For Bas
	// Subscription---------------------------------------//

	@Test(enabled = true, priority = 91, groups = { "RegistrationsPositive", "All" })
	public void redeemGiftCardBasNewUser()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException 
	{
		...
		pricePerDay = 3.966666666666667; // <---------------- 119 kr/30 days = 3.966666666666667kr/day
		...
		String expSubs = "Duharabonnemanget:SILVER";
	...
	// ---------------------------------Redeeming GiftCard For Standard
	// Subscription-----------------------------------//

	@Test(enabled = true, priority = 92, groups = { "RegistrationsPositive", "All" })
	public void redeemGiftCardStandardNewUser()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException 
	{
		adminUn = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINUN");
		adminPwd = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINPWD");
		...
		pricePerDay = 5.633333333333333; // <---------------- 169 kr/30 days =
											// 5.633333333333333 kr/day

		log.info("REDEEMING GIFTCARD FOR GULD SUBSCRIPTION");
		...
		String actSubs = acc.getMySubscription();
		String actSubsTrim = actSubs.replaceAll("\\s+", "");
		String expSubs = "Duharabonnemanget:GULD";
	...
	// -----------------------------Redeem GiftCard for Premium
	// Subscription---------------------------------//

	@Test(enabled = true, priority = 93, groups = { "RegistrationsPositive", "All" })
	public void redeemGiftCardPremiumNewUser()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		adminUn = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINUN");
		adminPwd = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINPWD");
		adminUrl = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINURL");
		...
		log.info("REDEEMING GIFTCARD FOR FAMILJ SUBSCRIPTION");
		...
		String actSubs = acc.getMySubscription();
		String actSubsTrim = actSubs.replaceAll("\\s+", "");
		String expSubs = "Duharabonnemanget:FAMILJ";
	...
	// ----------------------------Redeeming GiftCard As Existing User Without
	// Login----------------------------------//

	@Test(enabled = true, priority = 94, groups = { "RegistrationsPositive", "All" })
	public void redeemGiftCardExistingUserWithoutLogin()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException 
	{
		...
		else if (initSubs.contains("GULD")) 
		{
			pricePerDay = 5.633333333333333; // <---------------- 169 kr/30 days
												// = 5.633333333333333 kr/day
			String actSubs = acc.getMySubscription();
		...
		else if (initSubs.contains("FAMILJ")) {
			pricePerDay = 6.633333333333333; // <---------------- 199 kr/30 days = 6.633333333333333kr/day
	...
	// ----------------------------Redeeming GiftCard As Existing User With
	// Login----------------------------------//

	@Test(enabled = true, priority = 95, groups = { "RegistrationsPositive", "All" })
	public void redeemGiftCardExistingUserWithLogin()
	...
	public void redeemGiftCardNewUserNegative()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException 
	{
		...
		log.info("REDEEMING GIFTCARD FOR SILVER SUBSCRIPTION");
		...
		// SCENARIO 1: KEEPING ALL THE TEXT FIELDS BLANK AND CLICKING ON LOS IN
		// PRESENTKORT BUTTON
		...
		String expKodErr = "Vänligenfyllidinpresentkortskod";
		...
		Assert.assertEquals(actEmailErrTrim, expEmailErr,
				"Error Message at the E-PostAddress Textbox does not matches");
		...
		Assert.assertEquals(actConfEmailErrTrim, expConfEmailErr,
				"Error Message at the Confirm E-PostAddress Textbox does not matches");
		...
		String expWrongKodErr = "Presentkortskodenärogiltig";
		Assert.assertEquals(actWrongKodErrTrim, expWrongKodErr,
				"The Error Message Does not match on entering Wrong Giftcard Code");

		// SCENARIO 3: ENTERING THE WRONG EMAIL ADDRESS IN CONFIRM EMAIL
		// TEXTFIELD
		...
		Assert.assertEquals(actConfEmailErrTrim1, expConfEmailErr1,
				"Error Message at Upprepa e-postadress field Doesnot matches with the email id in E-postaddress textbox.");

		// SCENARIO 4: ENTERING THE PASSWORD WITH LESS THAN 4 CHARACTERS OR MORE
		// THAN 25 CHARACTERS
		...
		Assert.assertEquals(actPswdErrTrim1, expPswdErrTrim1,
				"Error Message at Lösenord field Doesnot matches with less than 4 characters");

		gc.clearNewPswd();
		gc.enterNewPassword("123456789QWERTYUIOPLKJHGFDSAZX"); // PASSWORD MORE
																// THAN 25
																// CHARACTERS
		gc.clickToRedeemAsNew();
		...
		Assert.assertEquals(actPswdErrTrim2, expPswdErrTrim2,
				"Error Message at Lösenord field Doesnot matches with more than 25 characters");
	...
	public void redeemGiftCardExistingUserNegative()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		adminUn = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINUN");
		adminPwd = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINPWD");
		adminUrl = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINURL");
		...
		// SCENARIO 5: ENTERING THE PASSWORD WITH LESS THAN 4 CHARACTERS OR MORE
		// THAN 25 CHARACTERS
		gc.clearExistingPresentKod();
		gc.clearExistingPassword();
		gc.clearExistingEPost();
		...
		gc.enterExistingPassword("123456789QWERTYUIOPLKJHGFDSAZX"); // PASSWORD
																	// MORE THAN
																	// 25
																	// CHARACTERS
		gc.clickToRedeemAsExisting();
